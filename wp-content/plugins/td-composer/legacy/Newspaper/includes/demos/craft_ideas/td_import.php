...
//footer
td_demo_misc::update_footer_logo(
    array(
...
socials
*/
td_demo_misc::add_social_buttons(
    array(
        'facebook' => '#',
        'googleplus' => '#',
        'twitter' => '#',
...
$demo_cat_1_id = td_demo_category::add_category(
    array(
        ...
        'sidebar_id' => '',
        'tdc_layout' => '',
        //THE MODULE ID 1 2 3 NO NAME JUST ID
        'tdc_sidebar_pos' => '',
...
$demo_cat_4_id = td_demo_category::add_category(
    array(
...
$demo_cat_5_id = td_demo_category::add_category(
    array(
...
$demo_cat_6_id = td_demo_category::add_category(
    array(
...
$demo_cat_7_id = td_demo_category::add_category(
    array(
...
$demo_cat_8_id = td_demo_category::add_category(
    array(
...
$demo_cat_9_id = td_demo_category::add_category(
    array(
...
// add pages
$td_about_page = td_demo_content::add_page(
    array(
        'title' => 'About me',
        'file' => TDC_PATH_LEGACY . '/includes/demos/craft_ideas/pages/about.txt',
        'template' => 'page.php',
        // the page template full file name with .php, for default no extension needed
        'td_layout' => '',
        'sidebar_position' => '',
        'homepage' => false
    )
);
$td_contact_page = td_demo_content::add_page(
    array(
        'title' => 'Contact',
...
$td_homepage_page = td_demo_content::add_page(
    array(
        'title' => 'Home',
        'file' => TDC_PATH_LEGACY . '/includes/demos/craft_ideas/pages/homepage.txt',
        'template' => 'page-pagebuilder-latest.php',
        // the page template full file name with .php, for default no extension needed
        'td_layout' => '18',
        'sidebar_position' => '',
        'homepage' => true
...
$parent_submenu_id = td_demo_menus::add_link(
    array(
