...
//        }
    ...
    function render($atts, $content = null) {
        ...
        if( $icon == '' ) {
            ...
            if( base64_encode( base64_decode( $icon ) ) == $icon ) {
                $icon_html = '<span class="tdw-search-icon tdw-search-icon-svg">' . base64_decode( $icon ) . '</span>';
            } else {
	    ...
	    $buffy = '<div class="' . $this->get_block_classes() . '" ' . $this->get_block_html_atts() . '>';
            ...
            if( $btn_icon != '' ) {
                if( base64_encode( base64_decode( $btn_icon ) ) == $btn_icon ) {
                    $btn_icon_html = '<span class="tdw-search-form-btn-icon tdw-search-form-btn-icon-svg">' . base64_decode( $btn_icon ) . '</span>';
                } else {
