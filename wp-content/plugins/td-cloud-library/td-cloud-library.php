...
Author: tagDiv
Version: 2.5 | built on 15.02.2023 13:25
...
//hash
define('TD_CLOUD_LIBRARY', 'd72a7d54cd61ce0a128c0a91d76ef60a');
...
add_action('tdc_welcome_panel_text', function() {
    if (tdc_util::get_get_val('tdbTemplateType') !== false) {
        ...
        <a href="https://tagdiv.com/submit-a-request/?utm_source=tdc&utm_medium=banner&utm_campaign=custom_work&utm_content=start_screen" title="Get free quote" target="_blank">
            <img style="margin-top:20px; border-radius: 3px;" alt="banner-composer" src="https://cloud.tagdiv.com/services-img/banner-composer.png">
        </a>
        <?php
    }
}, 11);
